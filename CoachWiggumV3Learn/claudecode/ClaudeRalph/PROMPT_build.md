You are running the Ralph build loop for this repository in Claude Code.
...
3. Read the relevant specs and docs for the chosen slice.
4. Read only the source files needed for that slice.
