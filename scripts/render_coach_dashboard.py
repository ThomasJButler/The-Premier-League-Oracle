...
FILE_CONTEXT = {
    "advancedPredictions.ts": "ELO, Poisson, and statistical prediction models",
    "optimizedPredictions.ts": "Production ensemble model (weighted combination)",
    "dataService.ts": "Singleton data layer \u2014 cache + API + historical loader",
    "footballData.ts": "Football-Data.org API client with rate limiting",
    "predictionTracker.ts": "Prediction persistence and accuracy tracking",
    "kelly.ts": "Kelly Criterion stake calculator",
    "value.ts": "Value bet detection engine",
    "betBuilder.ts": "Multi-market prediction generator",
    "ChatBot.svelte": "Oracle Chat \u2014 RAG-powered AI assistant",
    "Dashboard.svelte": "Main dashboard with stat cards and charts",
    "Predictions.svelte": "Match prediction cards with ensemble results",
    "SeasonStats.svelte": "Season statistics and betting intelligence",
    "TopScorers.svelte": "Premier League top scorers table",
    "Settings.svelte": "API keys, theme, and preferences",
    "LiveMatches.svelte": "Real-time match scores with adaptive polling",
    "KellyCalculator.svelte": "Kelly Criterion betting calculator UI",
    "ValueBets.svelte": "Value bet finder with EV calculations",
    "main.py": "FastAPI server \u2014 prediction + chat endpoints",
    "rag.py": "DataFrame RAG engine for data-grounded chat",
    "free_tier_features.py": "99-feature engineering for XGBoost model",
    "train_free_tier.py": "Model training script (XGBoost + ensemble)",
    "loop.sh": "Ralph automation loop \u2014 build/plan/coach modes",
